...
- [ ] **TEST-02**: Create builder pattern for programmatic config generation (derive_builder or manual)
- [ ] **TEST-03**: Document test fixture usage patterns in code comments or CLAUDE.md
...
- [ ] **TEST-06**: Migrate remaining test files (1 config) to use shared fixtures
...
- [ ] **DEDUP-04**: Create `src/utils/` module for shared utilities (or add to existing module)
...
| DEDUP-05 | Phase 7 | Pending |
| CMPLX-01 | Phase 8 | Pending |
| CMPLX-02 | Phase 8 | Pending |
| CMPLX-03 | Phase 8 | Pending |
| CMPLX-04 | Phase 8 | Pending |
| CMPLX-05 | Phase 8 | Pending |
