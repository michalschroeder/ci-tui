# Requirements Archive: v1.0 Code Quality
...
- [x] **COVR-06**: Widget tests for UI components using TestBackend
- [x] **COVR-07**: Achieve 60%+ code coverage for core modules

### Architecture

- [x] **ARCH-01**: Centralize state update logic in single `update()` function
- [x] **ARCH-02**: Verify panic hook exists for terminal restoration
- [x] **ARCH-03**: Ensure dirty flag optimization preserved during refactoring
...
| COVR-06 | Phase 5 | Complete |
| COVR-07 | Phase 5 | Complete |
